...
const TopLogo = () => {
    ...
    return (
        <div className={`fixed top-5 left-1/2 -translate-x-1/2 z-[110] transition-all duration-1000 ${isAtFooter ? 'opacity-0 -translate-y-12 pointer-events-none' : isScrolled ? 'opacity-40 scale-75 blur-[1px]' : 'opacity-100 scale-100'}`}>
